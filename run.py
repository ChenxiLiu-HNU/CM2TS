...
def get_multi_result(domain1,model1,pred_len1,seed1):
    ...
    for i in range(0, len(new_lines), 3):
        name = new_lines[i]
        #print(f"Processing line {i}: {name}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TimeMMD')
    ...
    parser.add_argument('--connector_dropout', type=float, default=0.3, help="dropout for modality connector")
    ...
    parser.add_argument('--rev_in', type=int, default=1, help='whether to use reversible normalization')
    ...
    parser.add_argument('--llm_from_stratch', type=int, default=0, help='whether to train from stratch')
    parser.add_argument('--llm_dim', type=int, default='768', help='LLM model dimension') # LLama7b:4096; GPT2-small:768; BERT-base:768
    parser.add_argument('--llm_layers', type=int, default=6)
    parser.add_argument('--text_emb', type=int, default=64)
    parser.add_argument('--text_random', type=int, default=0)
    parser.add_argument('--text_random_order', type=int, default=0)
    ...
    parser.add_argument('--text_col', type=str, default="report_fact,report_preds")
    parser.add_argument('--text_ts', type=int, default=0)
    parser.add_argument('--prompt_weight', type=float, default=0.5, help='prompt weight') #please tune this hyperparameter
    parser.add_argument('--fusion_method', type=str, default="add", help='fusion method')
    parser.add_argument('--history_weight', type=float, default=0.5, help='history weight')
    ...
    args.dec_in = 1
    args.c_out = 1
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!overwrite text_emb to d_model")
    args.text_emb = args.d_model
    fix_seed = args.seed
    ...
    if "ts" in args.text_col.split(','):
        args.text_ts = 1
        args.text_col = "NA"
        
    if "avg" in args.text_col.split(','):
        args.text_avg = 1
        args.text_col = "NA"
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_{}_textts{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_expand{}_dc{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.text_col.replace(',',''),
                args.model,
                args.data,
                args.text_ts,
                args.features,
