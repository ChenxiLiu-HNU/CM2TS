def print_args(args):
    ...
    print(f'  {"Checkpoints:":<20}{args.checkpoints:<20}{"Text Col:":<20}{args.text_col:<20}')
    print(f'  {"Text-based TS:":<20}{args.text_ts:<20}')
    print()
    ...
    if args.task_name in ['long_term_forecast', 'short_term_forecast']:
        ...
        print(f'  {"Random text order:":<20}{args.text_random_order:<20}{"Random text:":<20}{args.text_random}')
        print()

    if args.task_name == 'imputation':
        print("[Imputation Task]")
    ...
    print(f'  {"Output Attention:":<20}{args.output_attention:<20}{"Connector dropout:":<20}{args.connector_dropout:<20}')
    print(f'  {"Prompt weight:":<20}{args.prompt_weight:<20}{"rev in:":<20}{args.rev_in:<20}')
    print()
    ...
    print("[De-stationary Projector Params]")
