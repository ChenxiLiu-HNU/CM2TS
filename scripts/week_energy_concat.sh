...
start_index=$1
end_index=$2
root_paths=("./data/combined/Energy")
data_paths=("Energy_all_2011.csvv") 
...
text_len=1
text_ts=0
text_col=("report_fact" "search_fact" "report_preds,search_preds")
text_random=0
text_random_order=0
text_emb=32
length=${#root_paths[@]}
                    ...
                    do
                      ...
                      do
                        python -u run.py \
                          ...
                          --learning_rate $lr \
                          --train_epochs $te \
                          2>&1 | tee -a logs/${model_id}_${seed}_36_${pred_len}_text${text_len}_fm${fusion_method}_prompt${pw}_fullLLM${use_fullmodel}.log
                      done
                    done
                  done
                done
